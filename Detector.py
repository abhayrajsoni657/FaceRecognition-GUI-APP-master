...
def main_app(name):
        ...
        while True:
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.putText(frame, str(confidence), (x+5,y+h-5), font, 1, (255,255,10), 1)

                if(int(confidence)>=50):
                    cv2.putText(frame,str(Eligible), (x+5,y+h+50), cv2.FONT_HERSHEY_PLAIN,1,(0,250,40),1,cv2.LINE_AA)
                else:
                    cv2.putText(frame,str(Not_Eligible), (x+5,y+h+50), cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),1,cv2.LINE_AA)
